...
// Obręcz2 - 4 grupa
obrecz2Cylinder1 = new THREE.CylinderGeometry(1.7, 1.7, 0.25, 100);
...
segment3_obrecz2.position.set(0, 1.27, 0);
...
glowaCylinder2 = new THREE.CylinderGeometry(0.1,1.5, 1, 100);
glowaGora = new THREE.Mesh(glowaCylinder2, kolorFigury);

glowaGora.position.set(0,3.45, 0);
